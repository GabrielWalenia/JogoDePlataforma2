TARGET = game
SOURCES = main.c ./recursos/personagem.c ./recursos/inimigo.c ./recursos/joystick.c ./recursos/background.c ./recursos/serpente.c ./recursos/pistol.c ./recursos/bullet.c ./recursos/torre.c 
